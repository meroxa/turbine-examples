...
function generateAddressObject(json) {
  ...
  if (json && json.address_components) {
    metadata.city =
      (json.address_components[0] && json.address_components[0].long_name) ||
      "";
    metadata.region =
      (json.address_components[1] && json.address_components[1].long_name) ||
      "";
    metadata.state =
      (json.address_components[2] && json.address_components[2].long_name) ||
      "";
    metadata.country =
      (json.address_components[3] && json.address_components[3].long_name) ||
      "";
    metadata.postal_code =
      (json.address_components[4] && json.address_components[4].long_name) ||
      "";
  }
